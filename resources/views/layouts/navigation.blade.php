<nav x-data="{ open: false }" class="bg-black text-white border-b border-gray-800">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="{{ route('dashboard') }}" class="text-2xl font-bold text-green-500">
                    Uber
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <x-nav-link :href="route('trip-requests.index')" :active="request()->routeIs('trip-requests.*')"
                    class="flex items-center gap-2 text-gray-300 hover:text-green-400 transition">
    ...
    <!-- Mobile Menu -->
    <div :class="open ? 'block' : 'hidden'" class="md:hidden bg-black border-t border-gray-800">

        <div class="px-4 py-3 space-y-3">

            <a href="{{ route('dashboard') }}" class="flex items-center gap-2 text-gray-300 hover:text-green-400">
                Dashboard
            </a>

            <a href="{{ route('vehicles.index') }}" class="flex items-center gap-2 text-gray-300 hover:text-green-400">
                Vehicles
            </a>

            <a href="{{ route('trips.index') }}" class="flex items-center gap-2 text-gray-300 hover:text-green-400">
                Trips
            </a>

            <a href="{{ route('trip-requests.index') }}" class="flex items-center gap-2 text-gray-300 hover:text-green-400">
                Requests
            </a>

            <a href="{{ route('my-trips') }}" class="flex items-center gap-2 text-gray-300 hover:text-green-400">
                Bookings
            </a>
